...
struct arbol *
buscarHijo (struct arbol *raiz, int dato)
{
  if (raiz == NULL)
    {
      return NULL;
...
struct arbol *
buscarPadre (struct arbol *raiz, struct arbol *hijo, int dato)
{
  if (raiz == NULL)
    {
      return NULL;
...
struct arbol *
buscarMenorMayores (struct arbol *raiz)
{
  if (raiz == NULL)
    {
      return NULL;
...
struct arbol *
buscarMayorMenores (struct arbol *raiz)
{
  if (raiz == NULL)
    {
      return NULL;
...
struct arbol *
eliminar (struct arbol *raiz, int dato)
{
  if (raiz == NULL)
    {
      return NULL;
